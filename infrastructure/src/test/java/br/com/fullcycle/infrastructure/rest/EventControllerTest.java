...
class EventControllerTest {
    ...
    void setUp() {
        ...
        disney = partnerRepository.create(Partner.newPartner("Disney", "55.918.450/0001-50", "disney@gmail.com"));
    }
    ...
    public void testReserveTicket() throws Exception {
        ...
        var sub = new SubscribeDTO(eventId, johnDoe.getCustomerId().value());
